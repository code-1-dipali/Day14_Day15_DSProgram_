...
import com.bridgelabz.program.LinkedListPrg;
...
public class Utility {
    ...
    public void readWordFromFile() {
        try {
            File file = new File("F:\\DataStructureProgram\\src\\text");
    ...
    public void readIntegerFromFile() {
        try {
            File file = new File("F:\\DataStructureProgram\\src\\iInteger.txt");
            BufferedReader buffer = new BufferedReader(new FileReader(file));
